  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] pt-24 pb-16 px-6 md:px-10">
                ...
                {listings.map((l) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border capitalize ${STATUS_COLORS[l.status] ?? STATUS_COLORS.available}`}
                      >
                        {l.status}
                      </span>
                    </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-6">
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold border ${createdListing ? "bg-emerald-500/20 border-emerald-500/40 text-emerald-400" : "bg-emerald-500 border-emerald-400 text-white"}`}
              >
                1
              </div>
              <div
                className={`flex-1 h-px ${createdListing ? "bg-emerald-500/40" : "bg-white/10"}`}
              />
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold border ${createdListing ? "bg-emerald-500 border-emerald-400 text-white" : "bg-white/4 border-white/10 text-slate-500"}`}
              >
                2
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={inputClass}
                        onFocus={() => {
                          const suggestions = filterSpeciesSuggestions(
                            form.species,
                          );
                          setSpeciesSuggestions(suggestions);
                          setShowSuggestions(suggestions.length > 0);
      ...
      {showEditModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          <div
            className="w-full max-w-md bg-[#0f1a2e] border border-white/9ded-2xl px-8 py-8 shadow-[0_24px_64px_rgba(0,0,0,0.6)]"
            style={{ animation: "cardIn 0.3s cubic-bezier(0.22,1,0.36,1)" }}
          >
            {/* Step indicator */}
            <div className="flex items-center gap-2 mb-6">
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold border ${editStep === 2 ? "bg-emerald-500/20 border-emerald-500/40 text-emerald-400" : "bg-emerald-500 border-emerald-400 text-white"}`}
              >
                1
              </div>
              <div
                className={`flex-1 h-px ${editStep === 2 ? "bg-emerald-500/40" : "bg-white/10"}`}
              />
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold border ${editStep === 2 ? "bg-emerald-500 border-emerald-400 text-white" : "bg-white/4 border-white/10 text-slate-500"}`}
              >
                2
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onBlur={() =>
                          setTimeout(() => setEditShowSuggestions(false), 150)
                        }
                      />
                      {editShowSuggestions &&
                        editSpeciesSuggestions.length > 0 && (
                          <div className="absolute top-full left-0 right-0 mt-1 bg-[#1a2f45] border border-white/10 rounded-lg shadow-lg z-10 overflow-hidden">
